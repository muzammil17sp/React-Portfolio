      ...
      <div className=" max-w-90 mx-auto  flex items-center flex-col md:flex-row justify-between">
        <div className="flex flex-col items-center md:items-stretch z-10">
          <div className="overflow-hidden">
            <motion.h2 variants={titleAnimation} initial="hidden" animate="show" className="text-2xl md:text-3xl text-white text-center md:text-left font-light mt-2 ">
              Welcome to my portfolio My name is
              <span className="text-underline font-black font-lower   mt-3 mx-5">Muzammil</span>
            </motion.h2>
          </div>
          <img />          <div className="overflow-hidden">
            <motion.div variants={titleAnimation} initial="hidden" animate="show" className="flex items-center space-x-9 my-4  ">
...
<a href="#projects">
        ...
        {/* <div className=""> */}
        <motion.img variants={imageAnimation} initial="hidden" animate="show" className="md:h-3/6 md:w-3/6 z-10" src="/img/main.svg" alt="" />
        {/* </div> */}
        <Wave />
      </div>
    </div>
